            ...
            <section className="card">
                ...
                <div className="filters-bar">
                    ...
                    <button onClick={handleExportTablePDF} className="btn-export" title="Baixar relatório em PDF">
                        ...
                        <span className="export-label">Baixar PDF</span>
                    </button>
                </div>
                                        ...
                                        {debtBreakdown.items.map(item => (
                                            <div key={item.id} className={`breakdown-item ${item.type}`}>
                                                ...
                                                <div className="b-item-bottom">
                                                    <span className={`b-item-badge ${item.type}`}>
                                                        {item.type === 'debt' ? 'Somou na dívida' : 'Abateu da dívida'}
                                                    </span>
                                                    <span className={`b-item-amount ${item.type === 'debt' ? 'text-danger' : 'text-success'}`}>
